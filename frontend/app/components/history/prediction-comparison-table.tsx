...
import {BRAND_GRADIENT, TABLE_CELL_CENTER, TABLE_HEADER_CELL} from "@/app/util/css-classes"
            ...
            <table className="hidden w-full text-sm sm:table">
                <thead>
                    <tr className="text-[11px] uppercase tracking-wider text-slate-400 dark:text-gray-500">
                        ...
                        <th className={TABLE_HEADER_CELL}>W</th>
                        <th className={TABLE_HEADER_CELL}>D</th>
                        <th className={TABLE_HEADER_CELL}>L</th>
                    ...
                    {actualStandings.map(row => {
                        ...
                        return (
                            <tr key={row.teamId} className={`border-t border-slate-900/5 dark:border-white/5 ${positionAccent(row.position)}`}>
                                ...
                                <td className={TABLE_CELL_CENTER}>{row.won}</td>
                                <td className={TABLE_CELL_CENTER}>{row.drawn}</td>
                                <td className={TABLE_CELL_CENTER}>{row.lost}</td>
