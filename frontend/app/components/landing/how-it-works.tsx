    ...
    return (
        <div className="relative max-w-5xl w-full mx-auto">
            <div className={`flex flex-col items-center text-center ${compact ? "mb-12" : "mb-20"}`}>
                <span className="text-xs font-semibold tracking-[0.3em] text-pitch-700/90 dark:text-pitch-300/90 uppercase mb-4">How it works</span>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <div className="group relative rounded-xl border-[1.5px] border-slate-300 dark:border-white/15 bg-white dark:bg-gray-900">
                    <div className="relative h-full rounded-xl p-8 flex flex-col">
                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-pitch-600/15 ring-1 ring-pitch-600/30 dark:bg-pitch-400/15 dark:ring-pitch-400/30 text-2xl mb-5">
                            &#128526;
                        </div>
                    ...
                    <div className="relative h-full rounded-xl p-8 flex flex-col">
                        ...
                        <ul className="space-y-2 text-slate-600 dark:text-gray-400">
                            <li className="flex items-baseline gap-2">
                                <span className="font-mono font-bold text-pitch-700 dark:text-pitch-300 text-sm">5pt</span>
                                <span>Exact score</span>
                            </li>
                            <li className="flex items-baseline gap-2">
                                <span className="font-mono font-bold text-pitch-700 dark:text-pitch-300 text-sm">2pt</span>
            ...
            <div className={`flex flex-col items-center text-center ${compact ? "mt-20 mb-12" : "mt-28 mb-16"}`}>
                <span className="text-xs font-semibold tracking-[0.3em] text-pitch-700/90 dark:text-pitch-300/90 uppercase mb-4">Power-ups</span>
                <h2 className={`font-display ${secondaryHeading} font-black tracking-tight`}>
                    ...
                    <span className="text-pitch-700 dark:text-pitch-300">chips</span>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <div className="group relative rounded-xl border-[1.5px] border-slate-300 dark:border-white/15 bg-white dark:bg-gray-900">
                    <div className="relative h-full rounded-xl p-8 flex flex-col">
                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-pitch-600/15 ring-1 ring-pitch-600/30 dark:bg-pitch-400/15 dark:ring-pitch-400/30 font-black text-pitch-700 dark:text-pitch-300 mb-5">
                            2&times;
                        </div>
