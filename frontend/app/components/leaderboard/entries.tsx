            ...
            {leaderboardData?.leagueName && (
                props.limit ? (
                    ...
                    <div className="mb-6 flex flex-col items-center text-center">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-cyan-400 to-green-300 shadow-lg shadow-cyan-500/30">
