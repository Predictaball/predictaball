...
export default function Leagues({initialLeagues}: {initialLeagues: League[]}): React.JSX.Element {
    return (
        <div className="w-full max-w-2xl mx-auto space-y-3">
            <div className="flex items-center justify-between px-2 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-500 dark:text-gray-500">
                <span>League</span>
                <span>Position</span>
            </div>
