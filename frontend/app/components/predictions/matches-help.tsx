    ...
    return (
        <HelpPopover label="How matches work">
            ...
            <ul className="space-y-1.5 pl-1">
                <li>
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-300">5pt</span> &mdash; exact score
                </li>
                <li>
                    <span className="font-mono font-bold text-cyan-600 dark:text-cyan-300">2pt</span> &mdash; correct result
                </li>
            </ul>
