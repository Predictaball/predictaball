...
export default function EmptyTicket(): React.JSX.Element {
    return(
        <div className="w-full p-3 text-slate-600 dark:text-gray-600 relative">
            <div className="w-full p-3 flex-row justify-between max-w-xl rounded-large bg-slate-100 dark:bg-gray-100">
