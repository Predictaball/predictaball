...
export default async function JoinLeagueInvite(
    ...
    return (
        <main className="relative flex min-h-screen flex-col items-center justify-center bg-slate-50 text-slate-900 dark:bg-gray-900 dark:text-white overflow-x-hidden px-4">
            ...
            <div className="relative w-full max-w-sm overflow-hidden rounded-xl border-[1.5px] border-slate-300 dark:border-white/15 bg-white dark:bg-gray-900 shadow-xl shadow-slate-900/5">
                    ...
                    {preview ? (
                        <>
                            ...
                            <h1 className="mt-3 text-2xl font-black tracking-tight">
                                Join &ldquo;<span className="text-pitch-700 dark:text-pitch-300">{preview.name}</span>&rdquo;
                            </h1>
