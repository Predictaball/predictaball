 ...
 * plus an uncapped streak bonus: the Nth consecutive correct pick (in kickoff
 * order) adds N-1 bonus points (0, 1, 2, …). Any miss resets the streak.
 *
...
object BracketScoring {
    ...
    fun scoreRun(matches: List<RunMatch>): RunResult {
        ...
        return RunResult(total, streak, perMatch)
    }
}
