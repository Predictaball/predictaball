...
class TestLeaderboardS3Service {
    ...
    fun writeLeaderboardShouldCallPutObjectWithCorrectParameters(): Unit = runBlocking {
        val leaderboard = listOf(
            LeaderboardInner(1, User("name", "secondName1", "user1", 10, 5), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(1, User("name", "secondName2", "user2", 10, 5), LeaderboardInner.Movement.IMPROVED),
        )
...
class LeaderboardTest {
    ...
    fun testFilterLeaderboardToLeague() {
        val globalLeagueLeaderboard = listOf(
            LeaderboardInner(1, User("name", "secondName5", "user5", 10, 5), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(2, User("name", "secondName3", "user3", 5, 7), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(3, User("name", "secondName1", "user1", 5, 5), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(3, User("name", "secondName4", "user4", 5, 5), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(5, User("name", "secondName2", "user2", 3, 4), LeaderboardInner.Movement.WORSENED),
        )
        ...
        filteredLeaderboard shouldBe listOf(
            LeaderboardInner(1, User("name", "secondName5", "user5", 10, 5), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(2, User("name", "secondName1", "user1", 5, 5), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(2, User("name", "secondName4", "user4", 5, 5), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(4, User("name", "secondName2", "user2", 3, 4), LeaderboardInner.Movement.WORSENED),
        )
    }
    ...
    fun testCalculateMovement() {
        val previousLeaderboard = listOf(
            LeaderboardInner(1, User("name", "secondName5", "user5", 10, 5), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(2, User("name", "secondName3", "user3", 5, 7), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(3, User("name", "secondName1", "user1", 5, 5), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(3, User("name", "secondName4", "user4", 5, 5), LeaderboardInner.Movement.UNCHANGED),
        )

        val leaderboard = listOf(
            LeaderboardInner(1, User("name", "secondName1", "user1", 5, 5), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(1, User("name", "secondName4", "user4", 5, 5), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(3, User("name", "secondName3", "user3", 5, 7), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(4, User("name", "secondName5", "user5", 10, 5), LeaderboardInner.Movement.UNCHANGED),
            LeaderboardInner(5, User("name", "secondName2", "user2", 0, 0), LeaderboardInner.Movement.UNCHANGED),
        )
        ...
        leaderboardWithMovementRecalculated shouldBe listOf(
            LeaderboardInner(1, User("name", "secondName1", "user1", 5, 5), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(1, User("name", "secondName4", "user4", 5, 5), LeaderboardInner.Movement.IMPROVED),
            LeaderboardInner(3, User("name", "secondName3", "user3", 5, 7), LeaderboardInner.Movement.WORSENED),
            LeaderboardInner(4, User("name", "secondName5", "user5", 10, 5), LeaderboardInner.Movement.WORSENED),
            LeaderboardInner(5, User("name", "secondName2", "user2", 0, 0), LeaderboardInner.Movement.UNCHANGED),
        )
    }
}
